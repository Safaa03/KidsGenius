...
const questions =  [
  {
    sentence: "The <div class='drop-zone' id='fruit-drop'></div> is red and juicy.",
    correctAnswer: "apple",
    options: ["apple", "banana", "grape", "cherry"]
  },
  {
    sentence: "The <div class='drop-zone' id='fruit-drop'></div> is yellow and sweet.",
    correctAnswer: "banana",
    options: ["apple", "banana", "grape", "cherry"]
  },
  {
    sentence: "The <div class='drop-zone' id='fruit-drop'></div> is small and purple.",
    correctAnswer: "grape",
    options: ["apple", "banana", "grape", "cherry"]
  },
  {
    sentence: "The <div class='drop-zone' id='fruit-drop'></div> is red and sour.",
